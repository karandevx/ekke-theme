...
import ExclusiveEditions from "../components/exclusive-edition/exclusive-edition";
import useExclusiveEditions from "../page-layouts/exclusive-editions/useExclusiveEdition";
import {
  COLLECTION_DETAILS,
...
export function Component({ props = {}, blocks = [], globalConfig = {} }) {
  ...
  const listingProps = useExclusiveEditions({ fpi, props, slug });
  ...
  return (
    <div className="margin0auto basePageContainer">
      <ExclusiveEditions customLayout={true} {...listingProps} />
    </div>
  );
}
