...
const PAGE_SIZE = 12; // ✅ fixed: 18 products per page

const useExclusiveEditions = ({ fpi, props, slug: slugProp }) => {
  ...
  console.log("productList", props?.desktop_banner);
...
export default useExclusiveEditions;
