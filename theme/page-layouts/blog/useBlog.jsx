...
const useBlog = ({ fpi, props }) => {
  ...
  const paginationProps = useMemo(() => {
    ...
    //   const url = `https://api.fynd.com/service/platform/content/v1.0/company/${companyId}/application/${applicationId}/blogs/?${query}`;
    ...
    // // Example usage:
    // getBlogs(10540, "68aff4b324a96253d2e9505d", "aS1-ZrgCb")
    //   .then((data) => console.log("Blog Listing data", data))
