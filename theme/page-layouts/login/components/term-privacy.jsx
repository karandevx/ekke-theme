...
function TermPrivacy({ onChange, checked }) {
  ...
  return (
    <>
      <div className="flex items-start gap-2 my-3 w-full">
        <input
          type="checkbox"
          id="terms-privacy"
