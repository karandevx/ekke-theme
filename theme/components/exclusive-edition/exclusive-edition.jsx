...
import styles from "./exclusive-edition.less";
              ...
              <>
                ...
                <div className={styles.row1}>
                  <div className={styles.leftProductContainer}>
                    <div className={styles.leftProductCards}>
                ...
                <div className={styles.row2}>
                  {productList.slice(6, 8).map((product, idx) => (
                    <FDKLink
                      key={product?.uid || product?.slug}
                      className="cursor-pointer"
                      to={`/product/${product?.slug}`}
                ...
                <div className={styles.row4}>
                  {productList.slice(8, 12).map((product, idx) => (
                    <FDKLink
                      key={product?.uid || product?.slug}
                      className="cursor-pointer"
                      to={`/product/${product?.slug}`}
