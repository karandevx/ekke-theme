...
import { getProductImgAspectRatio, sanitizeHTMLTag } from "../helper/utils";
import { useThemeConfig } from "../helper/hooks";
import useInternational from "../components/header/useInternational";
import { fetchCartDetails } from "../page-layouts/cart/useCart";
import IntroOverlay from "../components/inter-overlay/inter-overlay";
import RadioPlayer from "../components/radio-player";
import { RadioPlayerProvider } from "../contexts/RadioPlayerContext";
import ToastProvider from "../components/custom-toaster";
...
export function ThemeProvider({ children }) {
  ...
  return (
    <>
      ...
      <IntroOverlay showMs={500} fadeMs={1200} showOnRefresh={true} />

      <ErrorBoundary>
        <ToastProvider>
          <RadioPlayerProvider>
            <ProfileDashboardProvider>{children}</ProfileDashboardProvider>
            {/* <RadioPlayer globalConfig={globalConfig} /> */}
          </RadioPlayerProvider>
        </ToastProvider>
      </ErrorBoundary>
    </>
